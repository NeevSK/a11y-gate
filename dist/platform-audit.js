 ...
 */
import { getWcagContrastRatio } from './contrast-math.js';
 ...
 */
export function auditPlatformCssCapabilities(css) {
    return {
 ...
 */
export function evaluatePlatformRules(options) {
    const results = [];
 ...
 */
export function runPlatformSuite(options, testHooks) {
